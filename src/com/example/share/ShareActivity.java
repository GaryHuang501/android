...
import com.example.share.PlusClientFragment.OnSignedInListener;
...
public class ShareActivity extends FragmentActivity implements View.OnClickListener,
    ...
    private Intent getInteractivePostIntent(PlusClient plusClient) {
        ...
        String dURL = "b/116550329676636097623/116550329676636097623/posts";
        ...
        String callToActionDeepLinkId = getString(R.string.mReturnID);
       ...
       //builder.setContentUrl(Uri.parse("gkh501.com/kill_da_tankz"));

        // Set the target deep-link ID (for mobile use).
        builder.setContentDeepLinkId(getString(R.string.mGPLusID), appTitle, userName + appDescription, Uri.parse(appImageURL));
